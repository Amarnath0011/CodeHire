    ...
    <main className="min-h-screen bg-slate-950 text-white px-4 sm:px-6 py-8">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-5 gap-4">
          ...
          <Stat label="In Review" value={count("review")} />
          ...
          <section className="lg:col-span-2 bg-white/5 border border-white/10 rounded-2xl p-6">
            ...
            <div className="mt-5 space-y-3">
              {applications.slice(0, 5).map((application) => (
                <div key={application._id} className="bg-slate-900 border border-white/10 rounded-xl p-4 flex items-center justify-between gap-3">
                  <div>
                  ...
                  <span className="text-xs capitalize px-3 py-1 rounded-full bg-white/10">{application.status}</span>
                </div>
              ))}
