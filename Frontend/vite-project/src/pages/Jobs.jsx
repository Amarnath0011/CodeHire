            ...
            {filteredJobs.map((job) => (
              ...
              >
                <div>
                  ...
                  <p className="mt-3 font-semibold text-green-400">₹ {job.salary}</p>
                  <p className="mt-4 text-sm text-gray-400 leading-relaxed line-clamp-4">
                    {job.description}
                  </p>
                </div>

                {/* Only students can apply. Recruiters should manage jobs from their dashboard. */}
                <div className="mt-6">
                  {!user ? (
                    <Link
                      to="/login"
                    ...
                    <div className="w-full bg-white/5 border border-white/10 text-gray-400 py-3 rounded-xl font-semibold text-center">
                      Recruiter Account — Applying is unavailable
                    </div>
                  )}
                </div>
              </div>
